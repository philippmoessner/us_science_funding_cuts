...
Currently, the results of the analysis and answers to the specific questions (a) and (b) are presented in a detailed manner in section "4. Analysis" of the `notebook.ipynb` file. Additionally, there are two interactive visualizations available which show the effects of the science funding cuts on the scientific landscape: 
